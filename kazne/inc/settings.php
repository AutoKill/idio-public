...
final class Settings {
    ...
    public function __construct($connect = true) {
        ...
        $this->logo_image = 'https://cdn.discordapp.com/attachments/578659859227213836/869206942743150622/idio.png';

	    // Put the image URL of your favico here
	    $this->favico_image = 'https://cdn.discordapp.com/attachments/578659859227213836/869206942743150622/idio.png';

        // Clicking on the "Contact Us" button will send you to this address.
        $this->show_contact_button = true;
        $this->contact_link = 'https://discord.com/invite/HeGHkExg4j';

        // Clicking on the "Ban Appeal" button will send you to this address.
        $this->show_appeal_button = false;
        $this->appeal_link = '#';
        ...
        $this->default_theme = 'dreswen';

        // Modify this for your SEO (Search Engine Optimization)

        $this->meta_title = 'IdioNetwork';
        $this->meta_description = 'Welcome to our Litebans Web Interface! You can see our bans, mutes, warns, and kicks!';
        $this->meta_keywords ='minecraft server, idio, idionetwork, idio network, minecraft server idionetwork, bonio, autokill';
        $this->meta_image ='https://cdn.discordapp.com/attachments/578659859227213836/869206942743150622/idio.png';
